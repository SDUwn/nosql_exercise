...
%>
<form class="layui-form" action="doEditStudent.jsp?SID=<%=SID %> " method="post">
	<div class="layui-form-item">
	    <label class="layui-form-label">TID</label>
	    <div class="layui-input-block">
	      <input name="SID1" class="layui-input" type="text" value="<%=SID %>" >
	    </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      <input name="BIRTHDAY1" class="layui-input" type="text" value="<%=BIRTHDAY %>" >
	    </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      <input name="CLASS1" class="layui-input" type="text" value="<%=CLASS %>" >
	    </div>
    </div>
    <div class="layui-form-item">
	    <div class="layui-input-block">
